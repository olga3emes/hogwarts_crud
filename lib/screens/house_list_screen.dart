          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                title: Text(h.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                subtitle: Text("Fundador: ${h.founder}", style: const TextStyle(fontSize: 14, fontStyle: FontStyle.italic)),
